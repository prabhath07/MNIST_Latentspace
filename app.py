...
with col1:
    l1 = st.slider('l1',1.6090515e-07, 0.9999213,value =0.9999213,step= 1.6090515e-07)
...
with col3:
    ...
    l0 = st.slider('l0',1.6090515e-07, 0.9999213, 1.6090515e-07)
    

arr = [l1,l2,l3,l4,l5,l6,l7,l8,l9,l0]
arr = np.array(arr)
